...
Designed as a learning project for graphics programming enthusiasts, it supports basic scene rendering, camera controls, and extensible architecture for features like ray tracing.
